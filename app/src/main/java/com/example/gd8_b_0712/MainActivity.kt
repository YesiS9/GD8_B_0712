package com.example.gd8_b_0712
...
class MainActivity : AppCompatActivity() {
        ...
        try{
            ...
            try{
                ...
                for(i in 0 until jsonArrayResult.length()){
                    ...
                    modelMain.strVicnity=jsonObjectResult.getString("vicinity")
    ...
    private fun initMarker(modelList: List<ModelMain>){
        for(i in modelList.indices){
            ...
            overlayItem.add(
                OverlayItem(
                    modelList[i].strName, modelList[i].strVicnity, GeoPoint(
            ...
            info.strVicnity = modelList[i].strVicnity
